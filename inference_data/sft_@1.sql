...
placeholder
placeholder
SELECT b.Title FROM Book b JOIN Author_Author_Book ab ON b.ISBN = ab.ISBN JOIN Author a ON ab.Author = a.idAuthor WHERE a.Name = 'George Orwell' ORDER BY b.SalePrice ASC LIMIT 1
placeholder
placeholder
placeholder
placeholder
...
placeholder
placeholder
SELECT P.Name AS PlanetName, COUNT(S.ShipmentID) AS TotalShipments FROM Shipment S JOIN Planet P ON S.Plant = P.PlantID GROUP BY P.PlantID
placeholder
placeholder
placeholder
